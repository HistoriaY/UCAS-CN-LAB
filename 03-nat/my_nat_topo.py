...
if __name__ == '__main__':
    ...
    h2.cmd('ifconfig h2-eth0 10.0.0.1/24')
    h2.cmd('route add default gw 10.0.0.2')

    n1.cmd('ifconfig n1-eth0 10.0.0.2/24')
    n1.cmd('ifconfig n1-eth1 180.0.0.1/24')

    n2.cmd('ifconfig n2-eth0 180.0.0.2/24')
    n2.cmd('ifconfig n2-eth1 10.0.0.2/24')
